...
from FOXSPAM import BOT0, BOT1, BOT2, BOT3, BOT4, BOT5, BOT6, BOT7, BOT8, BOT9, ALIVE_PIC, OWNER_ID

DEADLY_IMG = ALIVE_PIC if ALIVE_PIC else "https://te.legra.ph/file/480b27064515d563f982c.jpg"

Deadly_Button = [
        [
        Button.url("• Sᴜᴘᴘᴏʀᴛ •", "https://t.me/Usr_Fox")
        ],
        [
        Button.url("• Mᴀɪɴᴛᴀɪɴ Bʏ •", "https://t.me/Usr_Fox")
        ]
        ]
               
DeadlyX_Button = [
        [
        Button.url("Cʜᴀɴɴᴇʟ", "https://t.me/FoxSpamTool"),
        Button.url("Sᴜᴘᴘᴏʀᴛ", "https://t.me/FoxSpamTools")
        ],
        [
        Button.url("• Rᴇᴘᴏ •", "https://github.com/Fox-Spam/FOXSPAM")
        ]
        ]
