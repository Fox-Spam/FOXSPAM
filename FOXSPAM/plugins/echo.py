...
from FOXSPAM import BOT0, BOT1, BOT2, BOT3, BOT4, BOT5, BOT6, BOT7, BOT8, BOT9, SUDO_USERS, OWNER_ID
from FOXSPAM import CMD_HNDLR as hl
from resources.data import GROUP, FOXSPAM
from FOXSPAM.sql.echo_sql import addecho, get_all_echos, is_echo, remove_echo
...
async def echo(event):
  ...
  if event.sender_id in SUDO_USERS:
     if event.reply_to_msg_id is not None:
            ...
            if int(user_id) in FOXSPAM:
                    text = f"I Can't Echo @FoxSpamTools Owner"
